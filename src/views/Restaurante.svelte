...
<input type="text" placeholder="Busque por el nombre del restaurtante" bind:value={busqueda} >

<div class="container1">
  {#each restaurantes as restaurante}
    {#if restaurante.visible}
      <div style="border: 2px solid; margin:7px ;">
...
<style>
  .container1 {
    display: flex;
    flex-direction: row; /* Esto hace que los componentes se muestren en una fila horizontal */
  }
